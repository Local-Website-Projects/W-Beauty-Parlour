...
<?php include ('include/header.php');?>
   						...
   						<div class="slides">
							...
							<div class="slide is-active">
		       							...
		       							<div class="row justify-content-md-center">
		       								<div class="col col-lg-10">
					            				<div class="caption color--white">
								            		...
								            		<!-- Title -->
								              		<div class="title"><h2>Welcome to Reine Studio</h2></div>

								              		<!-- Text -->
										            <div class="text">

														<h5 class="h5-lg">Your one stop beauty shop</h5>

										               	<!-- Button -->
														<a href="gallery.php" class="btn btn--tra-white hover--white">
														   Discover More
														</a>
						        ...
						        <div class="image-container">
						           	<img class="image" src="images/slider/slide-1.jpg" alt="slide-background">
						        </div>
							...
							<div class="slide">
		       							...
		       							<div class="row justify-content-md-center">
		       								<div class="col col-lg-10">	          		
					            				<div class="caption color--white">
								            		...
								            		<!-- Title -->
								              		<div class="title"><h2>Enhance Your Natural Beauty</h2></div>

								              		<!-- Text -->
										            <div class="text">

										            	<h5 class="h5-lg">Feel yourself more beautiful</h5>

										                <!-- Button -->
														<a href="service.php" class="btn btn--tra-white hover--white">
														   View Salon Menu
														</a>
								...
								<!-- Slide Background Image -->
						        <div class="image-container">
						          	<img class="image" src="images/slider/slide-2.jpg" alt="slide-background">
						        </div>
							...
							<div class="slide">
		       							...
		       							<div class="row justify-content-md-center">
		       								<div class="col col-lg-10">     
					            				<div class="caption text-center color--white">
					            					...
					            					<!-- Title -->
								              		<div class="title"><h2>It’s a Pleasure to be Beautiful</h2></div>

								              		<!-- Text -->
										            <div class="text">

										            	<h5 class="h5-lg">Bring out your inner beauty</h5>

										         	 	<!-- Button -->
														<a href="contact.php" class="btn btn--tra-white hover--white">
														   Online Booking
														</a> 
								...
								<!-- Slide Background Image -->
						        <div class="image-container">
						           	<img class="image" src="images/slider/slide-3.jpg" alt="slide-background">
						        </div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6 order-last order-lg-2">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Text -->	
								<p class="mb-0">Sagittis congue augue egestas integer velna purus purus magna libero suscipit 
								...
								<div class="txt-block-btn">
									<a href="gallery.php" class="btn btn--tra-black hover--black">Discover More</a>
								</div>		
					...
					<div class="row justify-content-center">	
						...
						<div class="col-lg-10 col-xl-9">
							<div class="txt-block text-center">
								...
								<!-- Text -->	
								<p class="mb-0">Congue augue sagittis egestas integer velna purus purus magna nec suscipit 
								   and egestas magna aliquam ipsum vitae purus justo lacus ligula and ipsum lacinia primis 
								   cubilia
								</p>
			...
			<!-- SERVICES-2
			============================================= -->
			<section id="services-2" class="pt-6 services-section division">
				<div class="container">
			 			...
			 			<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
							...
							<div class="col">
								<div class="sbox-2 sb-4 wow fadeInUp">
									...
									<!-- Icon -->
									<div class="sbox-ico ico-65">
										<span class="flaticon-nail-polish"></span>
									</div>

									<!-- Text -->
									<div class="sbox-txt">
										<h5 class="h5-lg">Nails</h5>
										<p>Sagittis congue augue egestas integer diam purus magna and egestas magna suscipit</p>
									</div>
			...
			<!-- TEXT CONTENT
			============================================= -->
			<section class="pt-8 ct-06 content-section">
				<div class="container white--shape shape-shadow">
					<div class="row d-flex align-items-center">


						<!-- IMAGE BLOCK -->
						<div class="col-lg-6">
							<div class="ct-06-img left-column wow fadeInRight">
					...
					<div class="row justify-content-center">	
						<div class="col-md-10 col-lg-8">
							<div class="section-title text-center mb-6">	
								...
								<!-- Title -->	
								<h2 class="h2-title">Our Service Menu</h2>	
			 		...
			 		<div class="row">
			 			<div class="col">
			 				<div class="more-btn mt-5">
								<a href="service.php" class="btn btn--tra-black hover--black">View All Prices</a>
							</div>
						</div>
					</div>
			...
			<section class="pt-8 ct-07 ws-wrapper content-section">
				<div class="container">
					<div class="ct-07-wrapper bg--white block-shadow">
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-6 order-last order-lg-2">
								<div class="txt-block left-column">
									...
									<!-- Section ID -->	
						 			<span class="section-id">Come, Relax and Enjoy</span>

									<!-- Title -->	
									<h2 class="h2-md">Place where you will feel peaceful</h2>

									<!-- Text -->	
									<p class="mb-0">Sagittis congue augue egestas integer velna purus purus magna blandit 
										suscipit egestas magna diam ipsum aliquam vitae purus justo lacus ligula ipsum congue 
										tempor undo quisque fusce cursus neque 
									</p>

									<!-- Button -->
									<div class="txt-block-btn">
										<a href="contact.php" class="btn btn--black hover--tra-black">Book an Appointment</a>
									</div>
							...
							<div class="col-lg-6 order-first order-lg-2">
								<div class="img-block right-column">
									<img class="img-fluid" src="images/woman_05.jpg" alt="content-image">
								</div>
							</div>
					...
					<div class="row">
						<div class="col">
							<div class="banner-2-txt text-center color--white">
								...
								<!-- Button -->	
								<a href="contact.php" class="btn btn--tra-white hover--white">Book an Appointment</a>
			...
			<!-- TESTIMONIALS-2
			============================================= -->
			<div id="reviews-2" class="pt-8 reviews-section">
				<div class="container">
							...
							<div class="owl-carousel owl-theme reviews-2-wrapper">
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Etiam sapien sagittis diam congue augue massa varius ociis egestas ultrice varius 
											magna tempus an aliquet cursus suscipit pretium and lacinia molestie 
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Sagittis congue augue ligula molestie egestas magna ipsum vitae purus ipsum and 
											primis cubilia laoreet augue egestas donec ltrice ligula porta augue cursus 
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Mauris gestas magnis sapien molestie etiam sapien congue augue and egestas ultrice 
											ipsum vitae purus integer congue and magna egestas suscipit 
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Mauris donec magnis sapien quisque etiam pretium congue augue a volutpat undo lectus
											volute egestas aenean vitae sapien purus integer cubilia
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Sagittis congue augue ligula gravida egestas magna ipsum vitae purus ipsum and 
											primis cubilia laoreet augue egestas donec ltrice ligula a porta augue cursus 
											molestie molestie blandit justo
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<p>Etiam sapien sagittis diam congue augue massa varius egestas ociis ultrice varius 
											magna tempus an aliquet undo cursus suscipit augue pretium lacinia		   
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Congue augue sagittis ligula aliquet egestas magna ipsum vitae purus ipsum and 
											primis cubilia laoreet augue egestas donec ltrice ligula a cursus porta augue 
											molestie suscipit magna at tortor
										</p>
								...
								<div class="review-2">
									<div class="review-txt">
										...
										<!-- Text -->
										<p>Augue vitae purus tempus and egestas volutpat dignissim augue cubilia laoreet magna 
										   dolor suscipit luctus turpis blandit tempus gravida feugiat impedit
										</p>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6 order-last order-lg-2">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Section ID -->	
						 		<span class="section-id">You Are Beautiful</span>
	
								<!-- Title -->	
								<h2 class="h2-md">Unleash your inner beauty with Reine</h2>

								<!-- List -->
								<ul class="simple-list">

									<li class="list-item">
										<p>Aliquam vitae molestie quisque sapien diam purus egestas quaerat an aliquet 
											molestie ipsum
										</p>
									</li>

									<li class="list-item">
										<p class="mb-0">Sagittis congue augue magna volutpat porta mauris purus and 
								...
								<!-- Button -->
								<div class="txt-block-btn">
									<a href="service.php" class="btn btn--tra-black hover--black">Salon Menu</a>
								</div>	
						...
						<div class="col-lg-6 order-first order-lg-2">
							<div class="ct-05-img right-column wow fadeInLeft">
								<img class="img-fluid" src="images/woman_03.jpg" alt="content-image">
							</div>
						</div>
							...
							<div class="left-column wow fadeInRight">
								...
								<div class="ct-09-txt">
									...
									<ul class="advantages ico-30 clearfix">
										...
										<li><p><a href="contact.php">Book Now</a></p></li>
									</ul>
